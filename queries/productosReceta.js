...
function getAllInfoReceta(req, res, next){
	db.any('select r.nombre as receta, p.nombre as  producto,pp.cantidadProducto as cantidad,p.unidadDeMedida from productoPorReceta as pp, producto as p, receta as r  where pp.recet=r.id and pp.product=p.id;')
	.then(function(data){
...
*/
module.exports = {
	getAllInfoReceta : getAllInfoReceta
